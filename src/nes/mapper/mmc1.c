				...
				switch ((addr >> 13) & 0x03) {
					case 0:
						...
						switch (cart->REG[0] & 0x03) {
							...
							case 1: cart_map_ciram(&cart->chr, NES_MIRROR_SINGLE1);    break;
							case 2: cart_map_ciram(&cart->chr, NES_MIRROR_VERTICAL);   break;
							case 3: cart_map_ciram(&cart->chr, NES_MIRROR_HORIZONTAL); break;
						}
						break;
					case 1:
